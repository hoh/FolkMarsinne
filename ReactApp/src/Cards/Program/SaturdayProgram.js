...
const saturdayPlan = [
  ...
  {hour: '13:00', 'groups':[{name: 'Influences', duration: 2, kind: 'concert'},
                            true,
                            {name: 'Mad Tom Duo', duration: 3, kind: 'bal'},
                            false]},
  ...
  {hour: '14:30', 'groups':[false,
                            {name: 'Poke', kind: 'bal', duration: 3, kind: 'bal'},
                            false,
  ...
  {hour: '16:00', 'groups':[{name: 'Initiation bal folk', duration: 3, kind: 'learn'},
                            false,
                            {name: 'Durif - Champeval', duration: 4, kind: 'bal'},
                            false]},
  ...
  {hour: '18:00', 'groups':[false,
                            {name: 'Duo TTC', duration: 4, kind: 'bal'},
                            false,
                            {name: 'Podium libre', duration: 2, kind: 'free'}]},
  ...
  {hour: '21:30', 'groups':[true,
                            ...
                            true,
                            false]},
  {hour: '22:00', 'groups':[{name: 'Väsen', duration: 3, kind: 'concert'},
                            {name: 'Beat Bouet Trio', duration: 4, kind: 'bal'},
                            false,
                            false]},
  ...
  {hour: '00:00', 'groups':[false,
                            false,
                            {name: 'Shillelagh', duration: 4, kind: 'bal'},
                            false]},
