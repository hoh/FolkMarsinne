...
const fridayPlan = [
  ...
  {hour: '20h', 'groups': [false,
                           {name: 'Baila Tocamos (BE) bal', duration: 2, kind: 'bal'},
                           false, false]},
  {hour: '21h', 'groups': [false, true, false, false]},
  {hour: '22h', 'groups': [{name: 'Duo Montanaro-Cavez (BE-FR) concert', duration: 2, kind: 'concert'},
                           false,
                           {name: 'Wouter Vandenabeele et Jeroen Knapen (BE) bal', duration: 2, kind: 'bal'},
                           false]},
  {hour: '23h', 'groups': [true, false, true, false]},
  {hour: '00h', 'groups': [false,
                           {name: 'Les Zéoles (FR)', duration: 2, kind: 'bal'},
                           false, false]},
