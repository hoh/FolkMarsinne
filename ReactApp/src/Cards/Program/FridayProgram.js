...
const fridayPlan = [
  {hour: '20h', 'groups': [false, {name: "Baila Tocamos", duration: 2}, false, false]},
  {hour: '21h', 'groups': [false, true, false, false]},
  {hour: '22h', 'groups': [{name: "Wouter Vandenabeele", duration: 2},
                           false,
                           {name: "Duo Montanaro-Cavez", duration: 2},
                           false]},
  {hour: '23h', 'groups': [true, false, true, false]},
  {hour: '00h', 'groups': [false, {name: "Les Zéoles", duration: 2}, false, false]},
